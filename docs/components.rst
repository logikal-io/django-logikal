...
``<head>`` element of the given page template via the ``component_head`` block and the
...
Many of the components are implemented via Jinja macros, which can be imported via their respective
module as follows:
